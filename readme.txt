...
* **Easy installation**: The plugin can be installed using a convenient shortcode or PHP function. Multiple forms can be embedded on the same page.
...
* **Form wizard**: Easy step-by-step wizard allows to create forms from templates.
...
= 1.1 =
* Layout option (columns view) for checkboxes and radio buttons
