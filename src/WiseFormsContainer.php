...
/**
 * WiseForms DI container.
 *
 * @author Kainex <contact@kaine.pl>
 */
class WiseFormsContainer {
	/**
	...
	*/
	...
	public static function getLazy($classPathAndName) {
		...
		self::$proxies[$classPathAndName] = new WiseFormsContainerProxyClass($classPathAndName);
...
/**
 * Wise Forms DI proxy class.
 */
class WiseFormsContainerProxyClass {
	/**
	 * @var string
	 */
	...
	/**
	 * WiseFormsContainerProxyClass constructor.
	 *
	 * @param string $classPathAndName
	 */
	...
	public function __call($name, $arguments) {
		if ($this->targetClassObject === null) {
			$this->targetClassObject = WiseFormsContainer::get($this->targetClassPathAndName);
		}
