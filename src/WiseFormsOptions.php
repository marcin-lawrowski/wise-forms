...
/**
 * WiseForms class for accessing plugin options.
 *
 * @author Kainex <contact@kaine.pl>
 */
class WiseFormsOptions {
	const OPTIONS_NAME = 'wise_forms_options';

	/**
	* @var WiseFormsOptions
	*/
	...
	*/
	...
	private function __construct() {
		$this->options = get_option(WiseFormsOptions::OPTIONS_NAME);
	}
	
	public static function getInstance() {
		if (self::$instance === null) {
			$instance = new WiseFormsOptions();
	...
	*/
	public function saveOptions() {
		update_option(WiseFormsOptions::OPTIONS_NAME, $this->options);
	}
	...
	*/
	public function dropAllOptions() {
		delete_option(WiseFormsOptions::OPTIONS_NAME);
	}
